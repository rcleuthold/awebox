...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('model', 'aero', 'vortex',     'position_scaling_method',              'convection',   ('how to scale the wake position node wx variables: wingspan, chord-length, flight-radius, q10 scaling, convection distance', ['b_ref', 'c_ref', 'radius', 'q10', 'convection', 'kilometer']), 'x'),
        ...
        ('solver',  'cost',             'vortex_regularisation', 0, 1e0,        ('starting cost for vortex regularization', None), 's'),
