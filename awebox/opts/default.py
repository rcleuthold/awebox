...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('model', 'aero', 'actuator',   'position_scaling_method', 'default',  ('the method of estimating the actuator center position for problem scaling - default uses the standard node position scaling method', ['default', 'radius', 'altitude', 'b_ref', 'altitude_and_radius', 'radius_and_tether']), 'x'),
        ...
        ('params',  'model_bounds',  None,           'airspeed_limits',     np.array([-cas.inf, cas.inf]),  ('these are an overwrite option for the kite-geometry-specific airspeed limits in [m/s]', None),'s'),
        ...
        ('solver',  None,   None,   'record_ipopt_log',     False,      ('save a log of the ipopt record per trial per step. NOTE: not recommended in general, this will clutter the cwd', [True, False]), 't'),
