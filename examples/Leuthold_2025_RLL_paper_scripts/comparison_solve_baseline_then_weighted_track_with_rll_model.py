...
def run(inputs={}):
    ...
    ratio_power_to_position_weights = inputs['ratio_power_to_position_weights']
    ...
    if trial_baseline.optimization.solve_succeeded:
        ...
        options = help_op.adjust_weights_for_tracking(trial_baseline, options, ratio_power_to_position_weights=inputs['ratio_power_to_position_weights'])
